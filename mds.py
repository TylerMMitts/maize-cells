...
def mds_from_wasserstein_csv(csv_path, output_path=None, title=None, show=False):
    ...
    if output_path is None:
        ...
        output_path = f'tda_results/mds_{csv_basename}.png'
...
def mds_scaling(bns, labels=None, folder_names=None, sample_names=None, output_path='tda_results/mds_plot.png', title='MDS: Piecewise distances', show=False):
    # MDS parameters
