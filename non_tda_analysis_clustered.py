...
def create_visualizations(data, output_folder="non_tda_results_clustered", cluster_info=""):
...
def main():
    ...
    # Configuration
    wasserstein_csv = "chosen_tda_results/wasserstein_distances_H1.csv"
    measurements_folder = "measurements"
    output_folder = "non_tda_results_clustered"
    angle_tolerance = 5
